...
def get_context():
    ...
    context.title = "Frappe dms"
    context.description = "Visit dms online."
    context.og_image = "https://raw.githubusercontent.com/frappe/dms/main/.github/og_1200.png"
    ...
    if len(parts) >= 4:
        ...
        context.og_image = ""
        doc = frappe.get_doc("dms File", parts[3])
        if get_user_access(doc)["read"]:
            ...
            context.og_image = (
                "/api/method/dms.api.thumbnail_generator.create_image_thumbnail?entity_name="
                + doc.name
            )
