...
DriveFile = frappe.qb.DocType("dms File")
DrivePermission = frappe.qb.DocType("dms Permission")
Team = frappe.qb.DocType("dms Team")
TeamMember = frappe.qb.DocType("dms Team Member")
DriveFavourite = frappe.qb.DocType("dms Favourite")
Recents = frappe.qb.DocType("dms Entity Log")
DriveEntityTag = frappe.qb.DocType("dms Entity Tag")
