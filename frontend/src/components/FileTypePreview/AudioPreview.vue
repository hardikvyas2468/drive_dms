...
const src = ref(
  `/api/method/dms.api.files.get_file_content?entity_name=${props.previewEntity.name}`
)
...
watch(
  ...
  (newValue) => {
    loading.value = true
    src.value = `/api/method/dms.api.files.get_file_content?entity_name=${newValue.name}`
