...
export default {
  ...
  resources: {
    exportMedia() {
      return {
        url: "dms.api.files.export_media",
        params: {
          entity_name: this.entity.name,
        },
        auto: false,
    ...
    storeVersion() {
      return {
        url: "dms.api.files.create_doc_version",
        method: "POST",
        debounce: 1000,
        auto: false,
        onSuccess() {
    ...
    getversionList() {
      return {
        url: "dms.api.files.get_doc_version_list",
        method: "GET",
        params: {
          entity_name: this.entity.name,
        },
    ...
    userTags() {
      return {
        url: "dms.api.tags.get_user_tags",
        onError(error) {
          if (error.messages) {
    ...
    entityTags() {
      return {
        url: "dms.api.tags.get_entity_tags",
