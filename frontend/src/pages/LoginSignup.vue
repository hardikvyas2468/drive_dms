...
const oAuthProviders = createResource({
  url: "dms.api.product.oauth_providers",
  auto: true,
})

const oAuth = createResource({
  url: "dms.api.product.google_login",
  onSuccess(url) {
...
const verifyOTP = createResource({
  url: "dms.api.product.verify_otp",
  onSuccess: (data) => {
